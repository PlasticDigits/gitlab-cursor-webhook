...
| `gch-golden-image-finalize.md` | Rabby + **run** `scripts/e2e-anvil.sh` + verify log |
...
# Run finalize agent (runs e2e-anvil.sh + Rabby + toolchain; writes golden-image-verify.log)
